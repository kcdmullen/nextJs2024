...
// clsx makes conditional class names easy. We use one below, along with usePathname
// to set a conditional classname and styling for the active link in the nav
